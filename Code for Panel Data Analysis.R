...
library(stargazer)
#loading the dataset
pd<-read_excel("/Users/sherry/Desktop/pan_dat.xlsx")
...
as.data.frame(df)
write.csv(df,"C:/Users/sherry/Desktop/fix_coef.csv")
...
reg_data<-read_excel("/Users/sherry/Desktop/ols.reg.data.xlsx")
